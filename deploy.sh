...
CURRENTDIR=`pwd`
MAINFILE="responsive-io.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/responsiveio/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="14islands" # your svn username
